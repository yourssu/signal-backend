...
interface MeetingRoomRepository {
    ...
    fun existsByCreatorUuidAndCreationDateExceptExpired(creatorUuid: Uuid, creationDate: LocalDate): Boolean
    ...
    fun expireDueRoomByCreatorUuid(creatorUuid: Uuid, now: LocalDateTime): Int
