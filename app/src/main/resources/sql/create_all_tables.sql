...
CREATE TABLE meeting_room (
    ...
    creation_limit_date DATE DEFAULT NULL,
    ...
    UNIQUE KEY uk_meeting_room_creator_date (creator_uuid, creation_limit_date),
